import { j as jsxRuntimeExports, r as reactExports } from "./index-qd82Y0rz.js";
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col gap-2 ${alignClass} ${className}`, children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary text-xs font-body font-semibold tracking-widest uppercase", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-12 mb-1" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-2xl sm:text-3xl text-foreground leading-tight", children: [
      title,
      " ",
      titleAccent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold-text", children: titleAccent })
    ] }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm sm:text-base max-w-xl", children: subtitle })
  ] });
}
