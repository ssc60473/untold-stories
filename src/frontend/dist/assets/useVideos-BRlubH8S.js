...
import { h as Subscribable, p as pendingThenable, i as resolveEnabled, s as shallowEqualObjects, k as resolveStaleTime, n as noop, l as environmentManager, m as isValidTimeout, t as timeUntilStale, o as timeoutManager, q as focusManager, v as fetchState, w as replaceData, x as notifyManager, r as reactExports, y as shouldThrowError, z as useQueryClient, c as createLucideIcon, j as jsxRuntimeExports, A as Slot, d as cn, D as cva } from "./index-qd82Y0rz.js";
...
const SAMPLE_VIDEOS = [
  {
    ...
    description: "Rajasthan ke is rahasymay kile ki sachchi kahani, jo aaj bhi logon ke man mein darr paida karti hai. Raat ke baad yahaan jaana mana hai.",
    category: "Mystery",
    views: "2.4M",
    duration: "24:15",
  ...
  },
  {
    ...
    description: "Mughal samrajya ka yeh adbhut nirmaan — kya waqai ek prem ki nishaani hai ya iske peeche koi aur sachchi kahani chupi hai?",
    category: "History",
    views: "3.1M",
    duration: "31:42",
  ...
  },
  {
    ...
    description: "Gujarat ke samudra tatth ke neeche chupi hai ek praacheen sabhyata. Kya yahi thi Shri Krishna ki Dwarka nagari?",
    category: "History",
    views: "1.8M",
    duration: "28:55",
  ...
  },
  {
    ...
    description: "1825 mein ek poora gaon ek hi raat mein gum ho gaya. 1500 logon ka koi saboot nahin mila. Aaj bhi yeh jagah virani hai.",
    category: "Mystery",
    views: "4.2M",
    duration: "19:30",
  ...
  },
  {
    ...
    description: "90 laakh kitaben, 10,000 chhatra aur vishwa ki sabse badi gyanshala. Phir aaya ek dushman aur sab kuch khatam kar diya.",
    category: "History",
    views: "2.7M",
    duration: "35:18",
  ...
  },
  {
    ...
    description: "Duniya ka sabse bada rahasya — yahan jahaz aur havaijahaz bina kisi nishaani ke gum ho jaate hain. Kya hai iski sachchi wajah?",
    category: "Mystery",
    views: "5.6M",
    duration: "42:10",
  ...
  },
  {
    ...
    description: "Central India ke ghane janglon mein khoji ne aisi cheezein dhundhi hain jo itihas ko badal sakti hain.",
  ...
  },
  {
    ...
    description: "Bengal ke daldali ilaqon mein raat ko dikhti hai rahasymay roshni. Machhuaare mante hain yeh unke marhi saathiyon ki aatmaen hain.",
    category: "Horror",
    views: "3.8M",
    duration: "22:45",
...
export {
  ...
  Clock as C,
  SAMPLE_VIDEOS as S,
  useTrendingVideos as a,
  useVideos as b,
  useQuery as c,
  useFeaturedVideos as u
};
